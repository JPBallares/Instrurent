...
app.post('/item', urlencodedParser, function (req, res) {
    ...
    var sp = "'" + req.body.sp + "'",
        ...
        html = '',
        sql = 'SELECT item_name, price, renting_fee, stock, type_name, provider_name, provider_contact, provider_address FROM items natural join item_type natural join service_provider where item_id = ' + item;
