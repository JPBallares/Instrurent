 ...
 * @author james
 */
@WebServlet(name = "SAsp", urlPatterns = {"/SAsp"})
public class SAsp extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        response.setContentType("text/html;charset=UTF-8");
            ...
            String stmt;
                ...
                stmt = "select account_id, username, email, account_type, activate from accounts where status='a' and account_type='sp';";
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Logger.getLogger(SAsp.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
